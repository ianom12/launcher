...
public class Main_Page extends Fragment {
	...
	private OnClickListener mButtonClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case VIDEO_ID: {
				select = 0;
				text.setText("VIDEO");
				mAudioWidget.setVisibility(View.GONE);
				/*
				 * mRadioWidget.setVisibility(View.INVISIBLE);
				 * mAudioWidget.setVisibility(View.INVISIBLE);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		test1 = (Button) mV.findViewById(R.id.test);
		test1.setOnClickListener(mButtonClick);
		text.setText("test111111111");
	...
	void setToast(String msg) {
		// getActivity().Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
	}
